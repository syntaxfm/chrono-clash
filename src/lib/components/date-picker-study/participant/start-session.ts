...
//
// participant_id is generated by the admin factory at session creation
// (session-factory.ts), so the participant never sees or invents one.
//
// Throws on empty first name or wrong session status rather than silently
